...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 mb-4 items-center justify-center bg-muted text-muted-foreground',
      className,
    )}
    {...props}
  />
